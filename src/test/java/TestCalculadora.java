...
public class  TestCalculadora {
    ...
    public void crearCalculadora(){
        ...
        Assert.assertEquals(0, calculadora.elemento1);
        Assert.assertEquals(0, calculadora.elemento2);
        Assert.assertEquals(0, calculadora.resultado);
        Assert.assertEquals(0, calculadora.ultimoCalculo);
    ...
    @Test
    public void sumarConElUltimoValor(){
